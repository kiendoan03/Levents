...
<div class="topbar">
      ...
      <div class="body " style="margin-top:180px">
        ...
        <div class="col col-lg-4">
            <h4 class="text-center text-muted">Register</h4>
            <div class="contact_form mt-5">
            <form role = "form" method ="post" action="index.php?controller=login&action=add_user">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control"  name='email' style=" border: none; border-radius:0; border-bottom: 1px solid rgb(159, 159, 159);" placeholder="Email">
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                        <input type="password" class="form-control " name='re_password' style="width:345px; border: none; border-radius:0; border-bottom: 1px solid rgb(159, 159, 159);" placeholder="Confirm password">
                            </div>
                            ...
                            ?>
                            <div class="regis">Do you already have an account?
                                <a class="text-danger text-decoration-none" href="?controller=login&action=login">Login</a>
                            </div>
