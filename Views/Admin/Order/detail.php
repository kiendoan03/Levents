    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                      <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            Home</a></li>
                            <li class="breadcrumb-item "><a class="text-decoration-none text-dark" href="?controller=admin&redirect=order">
          ...
          <div class="row mt-3">
            ...
            <div class="row mt-3">
                  <h5 class="text-center text-info">Products purchased</h5>
                    ...
                    <div class="cart-items">
                        <div class="prd-items-cart">
                            ...
                            //     foreach($value as $id_size => $item){
                                ...
                                $total_price = $item['amount_prd'] * $item["price_detail"];
                            ...
                            <div class="row mt-3 mb-3">
                                ...
                                <div class="col col-lg-6 mt-3 prd-detail-cart">
                                    <div class="name text-secondary"><?= $item['name'] ?>/ <?= $item['name_color'] ?></div>
                                    <div class="size text-secondary mt-2">Size: SIZE <?php echo $item['name_size'] ?></div>
                                    <div class=" text-secondary mt-2">
                                        <div class="quantity">
                                            <p>x<?= $item['amount_prd'] ?></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="cart-footer mb-5 ">
                            <div class="total ">
                               <h5 class ="text-start d-inline" >Total prices: </h5>
                                <div class="text-danger text-end fw-bold fs-5">
