                                ...
                                <ul class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-dark bg-secondary ">
                                            <li><a class="dropdown-item bg-seconsary" href="#"><i class="fa-solid fa-user"></i>Profile</a></li>
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit user</li>
                    ...
                    <div class="row">
                        ...
                        <div class="row ">
                            ...
                            ?> 
                            <div class="row mb-2">
                                <h3 class="text-secondary"><?=$item['username']  ?> : <?php
                        if($item['role'] == 1){
                        ...
                        ?></h3>
                            ...
                            <form method="post" action="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=update&ID=<?=$item['ID']?>">
                            <?php
                                if(isset($error)){
                                    echo $error;
                                }
                            ...
                            <!-- <div class="alert alert-danger">Password mismatch!</div> -->
                                <div class="mb-3">
                                    <label>Name</label>
                                    <input name="username" value="<?= $item['username'] ?>" required class="form-control" placeholder="">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                    <input type="email" required  name="email" class="form-control" value="<?= $item['email'] ?>" id="exampleFormControlInput1" placeholder="name@example.com">
                                </div>
                                <div class="mb-3">
                                    <label for="inputPassword5" class="form-label">Password</label>
                                    <input type="password" required  name="password" id="inputPassword5" class="form-control" value="<?= $item['password'] ?>" aria-describedby="passwordHelpBlock">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="re_password" required type="password" value="<?= $item['password'] ?>"  class="form-control">
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    if($item['role'] == 1){
                                        ...
                                        echo '<option value="0" hidden>User</option>';
