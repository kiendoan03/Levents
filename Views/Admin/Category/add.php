        ...
        <div class="col-lg-3 col-md-5 ">
         ...
         <ol class="breadcrumb">
          <li class="breadcrumb-item"><a class="text-decoration-none text-dark" href="?controller=admin"><i class="fa-solid fa-house"></i> Home</a></li>
           ...
           <div class="row mb-2">
            <h2 class="text-danger"> Add new category</h2>
            <form action="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=store" role="form" method="post" enctype="multipart/form-data">
               <div class="mb-3">
               <label  class="form-label">Name</label>
               <input type="text" name="name_cate" required  class="form-control">
             ...
             <input class="form-control" required  type="file" name="image_cate" id="formFile" onchange="preview()">
             <div class="row mt-2">
             ...
             <input class="form-control" required type="file" name="image_size" id="formFile" onchange="preview1();">
             <div class="row mt-2">
                              <img id="frame1"  src="Public/images/no_image.jpg" />
